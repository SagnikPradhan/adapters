...
const DynamoDBAdapter = (client, options) => {
  var _a
  const TableName =
    (_a =
      options === null || options === void 0 ? void 0 : options.tableName) !==
      null && _a !== void 0
      ? _a
      : "next-auth"
  return {
    async getAdapter({ logger, session, secret, ...appOptions }) {
      ...
      return {
        ...
        async createUser(profile) {
          var _a, _b
          const userId = crypto_1.randomBytes(16).toString("hex")
          const now = new Date()
          const item = {
            pk: `USER#${userId}`,
            sk: `USER#${userId}`,
          ...
          const data = await client
            .update({
              ...
              ExpressionAttributeValues: {
                ...
                ":emailVerified":
                  (_b =
                    (_a = user.emailVerified) === null || _a === void 0
                      ? void 0
                      : _a.toISOString()) !== null && _b !== void 0
                    ? _b
                    : null,
        ...
        async createSession(user) {
          ...
          const sessionToken = crypto_1.randomBytes(32).toString("hex")
          const accessToken = crypto_1.randomBytes(32).toString("hex")
          const now = new Date()
          const item = {
            pk: `USER#${user.id}`,
        ...
        async deleteSession(sessionToken) {
          ...
          const data = await client
            ...
            .promise()
          if (
            ((_a = data === null || data === void 0 ? void 0 : data.Items) ===
              null || _a === void 0
              ? void 0
              : _a.length) <= 0
          )
        ...
        async getVerificationRequest(identifier, token) {
          ...
          const data = await client
            ...
            .promise()
          if (
            ((_a = data.Item) === null || _a === void 0
              ? void 0
              : _a.expires) &&
            data.Item.expires < Date.now()
          ) {
